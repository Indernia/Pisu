...
public class Antenna extends FieldAction {
    ...
    /**
     * Calculates the distance plus angle between the antenna and all players and
     * sets the turn order list in order of players from least distance to most
     * distance
     * 
     ...
     * determines the order in which the players play based on distance to the
     * antenna at the start of the programming phase
     * 
